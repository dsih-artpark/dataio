...
````{py:method} list_weather_datasets()
:canonical: dataio.sdk.user.DataIOAPI.list_weather_datasets

```{autodoc2-docstring} dataio.sdk.user.DataIOAPI.list_weather_datasets
```

````

````{py:method} _load_geojson(geojson: typing.Union[str, typing.Dict]) -> typing.Dict
:canonical: dataio.sdk.user.DataIOAPI._load_geojson

```{autodoc2-docstring} dataio.sdk.user.DataIOAPI._load_geojson
```

````

````{py:method} download_weather_data(dataset_name: str, variables: typing.List[str], start_date: str, end_date: str, geojson: typing.Union[str, typing.Dict], output_dir: typing.Optional[str] = None)
:canonical: dataio.sdk.user.DataIOAPI.download_weather_data

```{autodoc2-docstring} dataio.sdk.user.DataIOAPI.download_weather_data
```
