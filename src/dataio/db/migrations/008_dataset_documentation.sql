...
-- Caches README.md and metadata.json (data dictionary) content from file server
...
ADD COLUMN IF NOT EXISTS data_dictionary_json TEXT,
...
COMMENT ON COLUMN datasets.data_dictionary_json IS 'Cached metadata.json (data dictionary) content from file server';
